#pragma checksum "C:\IDTPDashboard\Views\Home\ICPNetworkMonitor.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "097065c1ec20c5643c641388d3555a86b5381b64"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"097065c1ec20c5643c641388d3555a86b5381b64", @"/Views/Home/ICPNetworkMonitor.cshtml")]
            ...
            switch ( chart.getDatasetMeta(i).type ) {
              case ""forceDirectedGraph"":
                ...
                case ""bar"":
                    ...
                    chart.getDatasetMeta(i).data.forEach(function (p, j) {
                        ctx.fi");
            WriteLiteral(@"llText(datasets[i].label, p.x, p.y + 20);
                    });
                    break;
                case ""horizontalBar"":
                    ctx.fillStyle = ""Black"";
        ...
        success: function (data) {     
            ...
            $.each(data, function (index, item) {
              ...
              if(item.isHelloTested==false){
                myChart");
            WriteLiteral(@".config.data.datasets[0]['pointBackgroundColor'][index] = '#f2f1ed'; 
              }
              else{
