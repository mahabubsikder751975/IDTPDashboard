#pragma checksum "C:\IDTPDashboard\Views\Home\ICPNetworkMonitor.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4e7135f14542032e5bdf989dd99ea2de81d7268e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4e7135f14542032e5bdf989dd99ea2de81d7268e", @"/Views/Home/ICPNetworkMonitor.cshtml")]
...
createNetChart();
 ...
 let originalpointcolor = [""#13fb03"", ""#13fb03"", ""#13fb03"", ""#13fb03"", ""#13fb03"", ""#13fb03"",""#13fb03"", ""#13fb03"", ""#13fb03"", ""#13fb03"", ""#13fb03"", ""#13fb03"",""#13fb03"", ""#13fb03"", ""#13fb03"", ""#13fb03"", ""#13fb03"", ""#13fb03"",""#13fb03"", ""#13fb03"", ""#13fb03"", ""#13fb03"", ""#13fb03""];
 
let copiedpointcolor = JSON.parse(JSON.stringify(originalpointcolor));
  ...
  myChart=new Chart(document.getElementById(id).getContext(""2d""), {
    ...
    data: {
      ...
      datasets: [
        {
");
            WriteLiteral(@"         // pointBackgroundColor: ""#13fb03"",            
          pointRadius: 10,
          //pointHoverRadius: 10,
    ...
    onComplete: function() {
        let ctx = this.");
            WriteLiteral(@"$context.chart.ctx;
...
loadData = function () {
 ...
 $.ajax({
        ...
        success: function (data) {     
            // loop through the All data and fill the dropdown
            $.each(data, fun");
            WriteLiteral(@"ction (index, item) {

              if(item.isHelloTested==false){
                myChart.config.data.datasets[0]['pointBackgroundColor'][index] = 'Red'; 
              }
              else{
