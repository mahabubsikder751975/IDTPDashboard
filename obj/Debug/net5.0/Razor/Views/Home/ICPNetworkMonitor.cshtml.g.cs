#pragma checksum "C:\IDTPDashboard\Views\Home\ICPNetworkMonitor.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4996af5a728ac5182876275517f78954b1d3c700"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4996af5a728ac5182876275517f78954b1d3c700", @"/Views/Home/ICPNetworkMonitor.cshtml")]
    ...
    data: {
      ...
      datasets: [
        {          
          pointRadius: 15,
      ");
            WriteLiteral(@"    pointHoverRadius: 15,
            ...
            switch ( chart.getDatasetMeta(i).type ) {
              case ""forceDirectedGraph"":
                ...
                case ""bar"":
                    ...
                    chart.getDatasetMeta(i).data.forEach(function (p, j) {
                        ctx.fillText");
            WriteLiteral(@"(datasets[i].label, p.x, p.y + 20);
                    });
                    break;
                case ""horizontalBar"":
                    ctx.fillStyle = ""Black"";
        ...
        success: function (data) {     
            ...
            $.each(data, function (index, item) {
              ...
              if(item.isHelloTested==false){
                myChart.confi");
            WriteLiteral(@"g.data.datasets[0]['pointBackgroundColor'][index] = '#f2f1ed'; 
              }
              else{
