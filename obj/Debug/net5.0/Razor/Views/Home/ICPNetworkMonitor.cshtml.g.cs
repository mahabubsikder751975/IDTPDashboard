#pragma checksum "C:\IDTPDashboard\Views\Home\ICPNetworkMonitor.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1d8e73d05d535727395b2f7affe019c277dcb485"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1d8e73d05d535727395b2f7affe019c277dcb485", @"/Views/Home/ICPNetworkMonitor.cshtml")]
...
createNetChart = function () {
                ...
                success: function (icpdata) {     
                    originalpointcolor = new Array(icpdata.length).fill(""#13fb03"");
            ...
            switch ( chart.getDatasetMeta(i).type ) {
              case ""forceDirectedGraph"":
                ...
                case ""bar"":
                    ...
                    chart.getDatasetMeta(i).data.forEach(function (p, j) {
                        ctx.fil");
            WriteLiteral(@"lText(datasets[i].label, p.x, p.y + 20);
                    });
                    break;
                case ""horizontalBar"":
                    ctx.fillStyle = ""Black"";
        ...
        success: function (data) {     
            ...
            $.each(data, function (index, item) {
              ...
              if(item.isHelloTested==false){
                myChart.");
            WriteLiteral(@"config.data.datasets[0]['pointBackgroundColor'][index] = '#f1e740'; 
              }
              else{
