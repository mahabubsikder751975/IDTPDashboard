#pragma checksum "E:\IDTPDashboard\Views\Home\MonitorServerPerformance.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ea0b7d5d27914da3bf7bdf719323cfef5890fce2"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ea0b7d5d27914da3bf7bdf719323cfef5890fce2", @"/Views/Home/MonitorServerPerformance.cshtml")]
   ...
   var divnetworkChartInstance = new Chart(divnetworkChart, {
    ...
    function addData(data) {
      if(data){
        ...
        divm");
            WriteLiteral(@"emoryChartInstance.config.data.datasets.forEach((dataset) =>{dataset.data.push(data['memory'])});
        ...
        if(updateCount > numberElements){
          ...
          divdiskChartInstance.config.data.datasets[0].");
            WriteLiteral(@"data.shift();   
...
//      setTimeout(updateData,updateInterval);
    ...
    function AddMachineDropDownList() {        
            ...
            //Build an array containing machine name records.
             ...
             ");
            WriteLiteral(@"     if(icpdata!='undefined'){
                        icpdata.forEach(obj => {
