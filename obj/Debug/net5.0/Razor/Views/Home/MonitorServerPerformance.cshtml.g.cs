#pragma checksum "E:\IDTPDashboard\Views\Home\MonitorServerPerformance.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ac757effc4a7a9a5ff8918c6d327825855f6db72"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ac757effc4a7a9a5ff8918c6d327825855f6db72", @"/Views/Home/MonitorServerPerformance.cshtml")]
...
<script>
 ...
 window.onload = function() {
    ...
    var divmemoryChartInstance = new Chart(divmemoryChart, {
        ...
        optio");
            WriteLiteral(@"ns: Object.assign({}, commonOptions, {
          title:{
            display: true,
            text: ""% Utilization"",
            fontSize: 18
   ...
   var divnetworkChartInstance = new Chart(divnetworkChart, {
    ...
    function addData(data) {
      if(data){
        ...
        divmemoryCha");
            WriteLiteral(@"rtInstance.config.data.labels.push(time);
 ...
 ");
            WriteLiteral(@"         divdiskChartInstance.config.data.datasets[0].data.shift();   
