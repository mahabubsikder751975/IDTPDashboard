#pragma checksum "C:\IDTPDashboard\IDTPDashboard\Views\Home\ServerMonitor.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7bccc29a1fa9c79d89bf318fa241769e1bfa3a5a"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7bccc29a1fa9c79d89bf318fa241769e1bfa3a5a", @"/Views/Home/ServerMonitor.cshtml")]
...
loadData = function () {
 ...
 $.ajax({
     ...
     ");
            WriteLiteral(@"         if(item.isInsertTested==false){
                myChart.config.data.datasets[item.serverRackId].backgroundColor[item.rackId]=""#CC7722"";   
              }
              else{
                 myChart.config.data.datasets[item.serverRackId].backgroundColor[item.rackId]=copieddatasets[item.serverRackId].backgroundColor[item.rackId];                
