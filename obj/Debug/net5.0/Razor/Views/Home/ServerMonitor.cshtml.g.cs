#pragma checksum "C:\IDTPDashboard\IDTPDashboard\Views\Home\ServerMonitor.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2e266007dd9963cd3362bf6a13cbda9edf6dc869"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2e266007dd9963cd3362bf6a13cbda9edf6dc869", @"/Views/Home/ServerMonitor.cshtml")]
...
let copieddatasets = JSON.parse(JSON.stringify(origindatas");
            WriteLiteral(@"ets));
...
const config = {
  ...
  options: {    
    ...
    onComplete: function() {
        ...
        let sum=new Array();
        datasets.forEach(function (da");
            WriteLiteral(@"taset, i) {
            ...
            switch ( chart.getDatasetMeta(i).type ) {
                ...
                case ""horizontalBar"":
                    ...
                    if (i==datasets.length-1) {ctx.fillText(sum[j], p.");
            WriteLiteral(@"x+10, p.y);}
        ...
        success: function (data) {     
            ...
            $.each(data, function (index, item) {
              if(item.serverHeartbeat==false){
                ...
                myChart.config.data.datasets[item.serverRackId].backgroundColor[item.rackId]=copieddatasets[item.serverRackId].backgroundColor[item.r");
            WriteLiteral("ackId];                \r\n                //myChart.update();\r\n              }                \r\n            });  \r\n            myChart.update();\r\n                     \r\n        }\r\n    });\r\n};\r\n\r\n");
