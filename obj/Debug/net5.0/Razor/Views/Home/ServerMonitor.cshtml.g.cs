#pragma checksum "C:\IDTPDashboardProject\IDTPDashboards\Views\Home\ServerMonitor.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "27f071f6cd6ff27528465a5c6496c970474dda96"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"27f071f6cd6ff27528465a5c6496c970474dda96", @"/Views/Home/ServerMonitor.cshtml")]
    ...
    public class Views_Home_ServerMonitor : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<List<ServerHealthDetails>>
    {
        ...
        {
#nullable restore
#line 2 "C:\IDTPDashboardProject\IDTPDashboards\Views\Home\ServerMonitor.cshtml"
...
let copieddatasets = JSON.parse(JSON.stringify(ori");
            WriteLiteral(@"gindatasets));
...
const config = {
  ...
  options: {    
    ...
    onComplete: function() {
        ...
        let sum=new Array();
        datasets.forEach(func");
            WriteLiteral(@"tion (dataset, i) {
            ...
            switch ( chart.getDatasetMeta(i).type ) {
                ...
                case ""horizontalBar"":
                    ...
                    if (i==datasets.length-1) {ctx.fillText(su");
            WriteLiteral(@"m[j], p.x+10, p.y);}
        ...
        success: function (data) {     
            ...
            $.each(data, function (index, item) {
              if(item.serverHeartbeat==false){
                ...
                myChart.config.data.datasets[item.serverRackId].backgroundColor[item.rackId]=copieddatasets[item.serverRackId].backgroundColo");
            WriteLiteral("r[item.rackId];                \r\n                //myChart.update();\r\n              }                \r\n            });  \r\n            myChart.update();\r\n                     \r\n        }\r\n    });\r\n};\r\n\r\nsetInterval(function() {\r\n");
