...
DendogramController.overrides = merge({}, [
    GraphController.overrides,
    {
        scales: {
            x: {
...
class DendogramChart extends Chart {
    constructor(item, config) {
...
export { DendogramChart, DendogramController, EdgeLine, ForceDirectedGraphChart, ForceDirectedGraphController, GraphChart, GraphController, TreeChart, TreeController };
